...
- **Typed mobs + AI**: thirteen species — cow, pig, sheep, chicken, zombie, skeleton, creeper, spider,
  ...
  **into lava**, and **deflect around walls** rather than stuttering into them (a chaser pursues
  ...
  naturally** by Minecraft 1.18+ rules: hostiles appear wherever it is **genuinely dark**
  (block-light 0), sampled through a 3D shell around you (±24 vertically) — so **caves spawn
  hostiles at any hour** while the **surface** spawns them **only at night**, and torches/lava
  genuinely keep an area mob-free (light management matters underground). Passive animals appear in
  **packs** on **sunlit grass**, drawn from a **biome-appropriate** pool. Hostiles cap at ~40 and
  despawn beyond a 64-block shell; passives never distance-despawn (pens and pets are permanent).
  Dropped items + XP orbs share the same entity physics.
